$(document).ready(function () {
    $(document).on("click", '#doublesessions', function() {
        $(document).ready(function(){
            $.ajax({
                url: '/load_session/' + $('#session_target').attr('data-session'),
                data: '',
                type: 'GET',
            ...
            setTimeout(function () {
                $.ajax({
                    url: '/load_session/' + $('#session_target2').attr('data-session'),
                    data: '',
                    type: 'GET',
    ...
    $(document).on('click', '#simple_session', function(){
